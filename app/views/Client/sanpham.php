        ...
        <div class="row">
            <div class="col-12">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <a class="loc" href="index.php?act=cao&id=<?php echo $id = $_GET['id'] ?>">Theo giá: Cao - Thấp</a>
                    <!-- <div>aaaaa</div> -->
                    <a class="loc" href="index.php?act=thap&id=<?php echo $id = $_GET['id'] ?>">Theo giá: Thấp - Cao</a>
                </div>
                                        ...
                                        <div class="product_footer d-flex align-items-center">
                                            ...
                                            <div style="margin-left: 35px;" class="add_to_cart">
                                                <form action="index.php?act=addtocart" method="POST">
                                                    ...
                                                    <input type="submit" class="dathang" name="addtocart" value="Mua">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
